package com.john_pank.chapter14.task24;

/**
 * Filosofia_Java
 * Created by John Pank on 03.12.2016.
 */

import java.util.*;

interface Factorys<T> {Part create();}
...
class Part {
	...
	static {
		...
		partFactories.add(new PartNull.Factory());
